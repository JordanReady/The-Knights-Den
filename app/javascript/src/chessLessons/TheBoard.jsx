      ...
      <div className="row lesson-row">
        ...
        <div className="col-12">
          <p className="content">
            ...
            your screen for reference. The chess board is an 8 by 8 grid of
            squares alternating colors from light to dark on every other square.
            The board is split up horizantally by what are known as ranks, and
            horizantally by what are known as files. These ranks and files are
            labeled by letters and numbers. Each horizontal rank has a file
            number 1 - 8 across the board, and each file has a file letter a - h
            across the board. The entire game of chess is restricted to piece
            movements inside these files and ranks!
          </p>
          <div className="lesson-btn-row">
            ...
            <button
              id="1"
              className="lesson-btn prev-btn disabled"
              onClick={handleClick}
            >
              Prev
            </button>
